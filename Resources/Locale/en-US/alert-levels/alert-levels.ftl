...
alert-level-violet-announcement = There is a significant biological/anomalous threat in the sector. Medical staff are advised to isolate individuals showing symptoms. Crewmembers are advised to limit interaction with others and enforce safety measures to prevent further spread.
alert-level-violet-instructions = Crewmembers are advised to limit interaction with others and enforce safety measures to prevent further spread.
...
alert-level-gamma-announcement = The Shipbaron has ordered DEFCON II. Crews are to avoid areas of conflict and/or potential danger where possible.
alert-level-gamma-instructions = Crewmembers are to avoid areas of conflict and/or danger where possible.
...
alert-level-delta-announcement = WARNING. WARNING. Detected nuclear exchange. Automatically raising alert level. Utmost caution and discretion advised. WARNING. WARNING.
...
alert-level-epsilon-announcement = WARNING. WARNING. The Shipbaron has raised security level in the sector. Utmost caution advised. WARNING. WARNING.
